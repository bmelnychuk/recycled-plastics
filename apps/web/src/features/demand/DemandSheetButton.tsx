...
export const DemandSheetButton: FC<{ demand: MaterialDemand }> = ({
  ...
  return (
    <>
      ...
      >
        {demand.material.type.toUpperCase()}
      </button>
            ...
            <ScrollArea className="h-full">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-4 px-4 pb-4 border-b">
                  {demand.description && (
                    <p className="leading-relaxed">{demand.description}</p>
                  )}
                  {/* Key Stats Grid */}
                  <div className="grid grid-cols-3 gap-5">
                    ...
                    <div className="flex items-start gap-2">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="font-semibold truncate">
                          <ColorLabel color={material.color} />
                        </div>
                      </div>
                    </div>
                    {/* Viscosity */}
                ...
                <div className="px-4 py-2">
                  ...
                  <MaterialDataTable material={material} />
                </div>
