...
import { Field, FieldLabel } from '@/design-system/components/ui/field';
...
import { MaterialData } from '@rp/core';
...
export const MaterialDataForm: FC<MaterialDataFormProps> = ({ control }) => {
  ...
  return (
    <>
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <FieldLabel htmlFor="material.packagingTypes">
              Packaging types
            </FieldLabel>
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <FieldLabel htmlFor="material.source">Material source</FieldLabel>
      ...
      />
      <h2 className="font-bold text-foreground my-4">Physical properties</h2>
      <Controller
        name="material.viscosity"
        control={control}
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <FieldLabel htmlFor="material.viscosity">Viscosity</FieldLabel>
            <MinMaxInput
              value={field.value?.value}
              onChange={(value) =>
                field.onChange(value ? { value } : undefined)
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <FieldLabel htmlFor="material.density">Density</FieldLabel>
            <MinMaxInput
              value={field.value?.value}
              onChange={(value) =>
                field.onChange(value ? { value } : undefined)
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <FieldLabel htmlFor="material.bulkDensity">Bulk density</FieldLabel>
            <MinMaxInput
              value={field.value?.value}
              onChange={(value) =>
                field.onChange(value ? { value } : undefined)
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <FieldLabel htmlFor="material.ashContent">Ash content</FieldLabel>
            <MinMaxInput
              value={field.value?.value}
              onChange={(value) =>
                field.onChange(value ? { value } : undefined)
      ...
      <Field>
        <FieldLabel
          className={hasFillerErrors ? 'text-destructive' : undefined}
        >
          Fillers
        </FieldLabel>
