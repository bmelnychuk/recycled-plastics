...
export const MaterialsCard: FC<{
  user?: SignedInUser;
  supply: SupplyViewModel[];
  demand: DemandViewModel[];
}> = ({ supply, demand, user }) => {
  const canAdd = Boolean(user?.company?.verified || user?.isAdmin);
                ...
                <DropdownMenuItem>
                  <Link
                    href={
                      user?.isAdmin
                        ? "/admin/supply/new"
                        : `/companies/${user?.company?.id}/supply/new`
                    }
                  >
                    New supply
                  </Link>
                ...
                <DropdownMenuItem>
                  <Link
                    href={
                      user?.isAdmin
                        ? "/admin/demand/new"
                        : `/companies/${user?.company?.id}/demand/new`
                    }
                  >
                    New demand
                  </Link>
